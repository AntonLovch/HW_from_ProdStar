...
function selectImage(index) {
  ...
  document.querySelector(".bigPicture img").src =
    data[selectedIndex].download_url;
  document.querySelector(".bigPicture img").classList.add("loading");
  document.querySelector(".bigPicture .author").textContent =
...
function init() {
  ...
  document
    ...
    .addEventListener("click", onPicturesClick);
